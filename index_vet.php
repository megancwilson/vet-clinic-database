...
<body>
    ...
    <div class="container">
        ...
        <a href="add_new_vet.php" class = "btn btn-dark" style = "margin-top: 10px;">Add New</a>
        ...
        include "connection.php";
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                <tr>
                    ...
                    <th><?php echo $row['year_of_grad'] ?></th>
                    <th><?php echo $row['animal_id'] ?></th>
                    <td>
                        <a href="edit_vet.php?id=<?php echo $row['id'] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square me-3"></i></a>
                        <a href="delete_vet.php?id=<?php echo $row['id'] ?>" class="link-dark"><i class="fa-solid fa-trash"></i></a>
                    </td>
                </tr>
